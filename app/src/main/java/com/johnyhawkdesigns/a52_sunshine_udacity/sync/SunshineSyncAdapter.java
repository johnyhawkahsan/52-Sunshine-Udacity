package com.johnyhawkdesigns.a52_sunshine_udacity.sync;
...
import com.johnyhawkdesigns.a52_sunshine_udacity.MainActivity;
import com.johnyhawkdesigns.a52_sunshine_udacity.R;
import com.johnyhawkdesigns.a52_sunshine_udacity.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    // Interval at which to sync with the weather, in seconds. 60 seconds (1 minute) * 180 = 3 hours
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
            ...
            //=======================================================This is copied from FetchWeatherTask's doInBackground method====================================================//

            // location is received from intent instead of param[0]
